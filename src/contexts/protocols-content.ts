...
export const protocolContexts: ContextFile[] = [
	...
	},
	{
		...
		description:
			'Complete Ethereum Name Service documentation including technical specifications, registrars, reverse resolution, and DNS integration',
		category: 'protocols',
	...
	},
	{
		...
		description:
			'Complete Ethereum Follow Protocol documentation including FAQ, technical details, NFT implementation, and social graph features',
		category: 'protocols',
